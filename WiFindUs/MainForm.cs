...
namespace WiFindUs
{
	...
	{
		public ConsoleForm Console { get { return console; } }

		protected ToolStripMenuItem ExitItem { get { return exitItem; } }
		protected ToolStripMenuItem ConsoleItem { get { return consoleItem; } }
		protected NotifyIcon TrayIcon { get { return trayIcon; } }
		protected ContextMenuStrip TrayIconMenu { get { return trayIcon == null ? null : trayIcon.ContextMenuStrip; } }
		...
		public virtual void TrayIconDoubleClick(object sender, EventArgs e)
		{
			ShowForm();
		}
