...
namespace WiFindUs.Eye
{
    ...
    public partial class Node : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntitySet<NodeHistory> _History;
        ...
        public Node()
        {
            this._History = new EntitySet<NodeHistory>(new Action<NodeHistory>(this.attach_History), new Action<NodeHistory>(this.detach_History));
            OnCreated();
        }
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Node_NodeHistory", Storage="_History", ThisKey="ID", OtherKey="NodeID", DeleteRule="CASCADE")]
        public EntitySet<NodeHistory> History
        {
            get
            {
        ...
        private void attach_History(NodeHistory entity)
        {
            this.SendPropertyChanging("History");
            entity.Node = this;
        }
    
        private void detach_History(NodeHistory entity)
        {
            this.SendPropertyChanging("History");
            entity.Node = null;
        }
