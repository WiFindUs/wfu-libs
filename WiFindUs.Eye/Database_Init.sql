...
-- Script date 10/03/2015 3:15:54 AM
-- Target Server: MySQL
-- Server Version: 5.6
...
CREATE TABLE wfu_eye_db.Waypoints (
   ...
   Longitude DOUBLE NULL,
   Altitude DOUBLE NULL,
   NextWaypointID BIGINT UNSIGNED NULL,
   ReportedByID BIGINT UNSIGNED NULL,
...
CREATE TABLE wfu_eye_db.Devices (
   ...
   IPAddress BIGINT NULL DEFAULT 0,
   WaypointID BIGINT UNSIGNED NULL,
...
CREATE TABLE wfu_eye_db.ArchivedWaypointResponders (
   WaypointID BIGINT UNSIGNED NOT NULL,
