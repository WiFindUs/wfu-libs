...
-- 
DROP TABLE wfu_eye_db.DeviceHistories;

-- 
-- Dropping a table wfu_eye_db.Devices 
-- 
DROP TABLE wfu_eye_db.Devices;

-- 
-- Dropping a table wfu_eye_db.ArchivedWaypointResponders 
-- 
DROP TABLE wfu_eye_db.ArchivedWaypointResponders;

-- 
-- Dropping a table wfu_eye_db.NodeHistories 
-- 
DROP TABLE wfu_eye_db.NodeHistories;

-- 
-- Dropping a table wfu_eye_db.Waypoints 
-- 
DROP TABLE wfu_eye_db.Waypoints;

-- 
-- Dropping a table wfu_eye_db.Nodes 
-- 
DROP TABLE wfu_eye_db.Nodes;

-- 
-- Dropping a table wfu_eye_db.Users 
-- 
DROP TABLE wfu_eye_db.Users;
...
-- 
-- Creating a table wfu_eye_db.NodeHistories 
-- 
CREATE TABLE wfu_eye_db.NodeHistories (
   ...
   CONSTRAINT FK_NodeHistories_Node FOREIGN KEY (NodeID) REFERENCES wfu_eye_db.Nodes (ID) ON DELETE CASCADE
);
