...
// Code is generated on: 22/11/2014 3:41:36 PM
//
...
namespace WiFindUs.Eye.Context
{
    ...
    /// </summary>
    [Table(Name = @"wfu_eye_db.DBDeviceStates")]
    public partial class DBDeviceState : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Storage = "_DeviceID", CanBeNull = false, DbType = "bigint(9) NOT NULL", IsPrimaryKey = true)]
        ...
        /// </summary>
        [Column(Storage = "_UserID", DbType = "bigint(18) NULL", UpdateCheck = UpdateCheck.Never)]
    ...
    /// </summary>
    [Table(Name = @"wfu_eye_db.DBDevices")]
    public partial class DBDevice : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Storage = "_ID", CanBeNull = false, DbType = "bigint(9) NOT NULL", IsPrimaryKey = true)]
        public long ID
        {
            get
            {
        ...
        /// </summary>
        [Column(Storage = "_IPAddressRaw", CanBeNull = false, DbType = "bigint(9) NOT NULL", UpdateCheck = UpdateCheck.Never)]
        ...
        /// </summary>
        [Column(Storage = "_WaypointID", DbType = "bigint(9) NULL", UpdateCheck = UpdateCheck.Never)]
    ...
    /// </summary>
    [Table(Name = @"wfu_eye_db.DBNodeStates")]
    public partial class DBNodeState : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Storage = "_NodeID", CanBeNull = false, DbType = "bigint(9) NOT NULL", IsPrimaryKey = true)]
        public long NodeID
        {
            get
            {
    ...
    public partial class DBNode : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Storage = "_Number", CanBeNull = false, DbType = "bigint(9) NOT NULL", UpdateCheck = UpdateCheck.Never)]
        public long Number
        {
            get
            {
    ...
    public partial class DBUser : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// There are no comments for ID in the schema.
        /// </summary>
        [Column(Storage = "_ID", AutoSync = AutoSync.OnInsert, CanBeNull = false, DbType = "bigint(9) NOT NULL", IsDbGenerated = true, IsPrimaryKey = true)]
        public long ID
        {
            get
            {
    ...
    /// </summary>
    [Table(Name = @"wfu_eye_db.DBWaypoints")]
    public partial class DBWaypoint : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Storage = "_NextWaypointID", DbType = "bigint(9) NULL", UpdateCheck = UpdateCheck.Never)]
        ...
        /// </summary>
        [Column(Storage = "_ReportedByID", DbType = "bigint(9) NULL", UpdateCheck = UpdateCheck.Never)]
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="DBWaypoint_DBUser", Storage="_DBArchivedResponders", ThisKey="ID", OtherKey="ID", LinkTableName=@"wfu_eye_db.DBWaypoints_DBUsers", LinkThisKey=@"DBWaypoints_ID", LinkOtherKey=@"DBUsers_ID")]
